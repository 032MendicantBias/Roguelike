...
{
    /// <summary>
    /// A piece of UI responsible for rendering text.
    ...
    public class Label : BaseObject
    {
        ...
        /// <summary>
        /// A SpriteFont which can be used to draw text (much like the SpriteBatch).
        /// Lazily evaluated because we will need it before we call LoadContent.
        /// </summary>
